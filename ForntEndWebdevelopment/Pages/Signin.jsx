...
export default function Signin() {
  ...
  const handlelogin = async (e) => {
    ...
    if(!name || !email || !password){
      return handleError("name email and password are required for the successful signin..");
    }
    try{
      const url = "https://indoreplantwebapplication-2.onrender.com/auth/signup";
      ...
      <form className="mt-40" onSubmit={handlelogin}>
        ...
        <div className="text-center mt-5">
          <input
            ...
            className="border-1 border-gray-400 bg-white text-black w-[30%] px-3 h-[6vh]"
          ...
          <input
            ...
            className="border-1 border-gray-400 w-[30%] bg-white text-black px-3 h-[6vh] mt-5"
        ...
        <div className="flex justify-end mr-[35%] gap-50 mt-3 text-[15px]">
          <Link to={"/login"}>
            <p className="cursor-pointer text-white">Login into account</p>
          </Link>
        </div>
